...
item replace entity @a[tag=flag,team=1blue] armor.head minecraft:red_banner{display:{Name:'{"translate":"Red Flag","color":"red"}',Lore:['{"text":"The Red team\'s flag"}','{"text":"Return it to your point, but make sure your own flag is safe!"}']},HideFlags:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1}]}