...
item replace entity @a[tag=flag,team=3red] armor.head minecraft:blue_banner{display:{Name:'{"translate":"Blue Flag","color":"blue"}',Lore:['{"text":"The Blue team\'s flag"}','{"text":"Return it to your point, but make sure your own flag is safe!"}']},HideFlags:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1}]}