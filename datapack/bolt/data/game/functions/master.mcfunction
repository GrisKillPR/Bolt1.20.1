...
item replace entity @a[gamemode=adventure,nbt=!{Inventory:[{Slot:17b,id:"minecraft:arrow",Count:4b}]},scores={gm_inGame=1}] container.17 with arrow 4
item replace entity @a[gamemode=adventure,nbt=!{Inventory:[{Slot:0b,id:"minecraft:bow",Count:1b}]},tag=!frozen,scores={gm_inGame=1}] container.0 with bow{Unbreakable:1b}
