...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_respawn_time] if score respawnTime gm_options matches 60 run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Respawn Time"}', '{"text":""}', '{"text":"3 Seconds","color":"green"}', '{"text":"","clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 1"}']}}
...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_respawn_time] if score respawnTime gm_options matches 100 run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Respawn Time"}', '{"text":""}', '{"text":"5 Seconds","color":"green"}', '{"text":"","clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 1"}']}}
...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_respawn_time] if score respawnTime gm_options matches 200 run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Respawn Time"}', '{"text":""}', '{"text":"10 Seconds","color":"green"}', '{"text":"","clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 1"}']}}
