...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_points_to_win] run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Flag Captures"}', '{"text":"text":"to win"}', '{"text":""}', '{"text":""}']}} destroy
...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_point_dropping] run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Allow item dropping"}', '{"text":"on points"}', '{"text":""}', '{"text":""}']}} destroy
...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_killstreaks] run setblock ~ ~ ~ minecraft:oak_wall_sign[facing=west]{front_text: {color: "aqua", messages: ['{"text":"Enable kill"}', '{"text":"Streaks"}', '{"text":""}', '{"text":""}']}} destroy
