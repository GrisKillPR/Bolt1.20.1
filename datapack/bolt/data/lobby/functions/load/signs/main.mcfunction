...
execute if score gameMode cm_main matches 0 run setblock 11 47 0 oak_wall_sign[facing=west]{front_text: {messages: ['{"bold":true,"color":"aqua","text":"Gamemode"}', '{"bold":true,"color":"green","text":"Capture the"}', '{"bold":true,"color":"green","text":"Flag"}', '{"clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 100"},"color":"black","text":"[Click to cycle]"}']}} destroy
execute if score gameMode cm_main matches 1 run setblock 11 47 0 oak_wall_sign[facing=west]{front_text: {messages: ['{"bold":true,"color":"aqua","text":"Gamemode"}', '{"bold":true,"color":"dark_aqua","text":"Capture the"}', '{"bold":true,"color":"dark_aqua","text":"Point"}', '{"clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 100"},"color":"black","text":"[Click to cycle]"}']}} destroy
execute if score gameMode cm_main matches 2 run setblock 11 47 0 oak_wall_sign[facing=west]{front_text: {messages: ['{"bold":true,"color":"aqua","text":"Gamemode"}', '{"bold":true,"color":"gold","text":"Free for"}', '{"bold":true,"color":"gold","text":"all"}', '{"clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 100"},"color":"black","text":"[Click to cycle]"}']}} destroy
execute if score gameMode cm_main matches 3 run setblock 11 47 0 oak_wall_sign[facing=west]{front_text: {messages: ['{"bold":true,"color":"aqua","text":"Gamemode"}', '{"bold":true,"color":"dark_blue","text":"Freeze"}', '{"bold":true,"color":"dark_blue","text":"Tag"}', '{"clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 100"},"color":"black","text":"[Click to cycle]"}']}} destroy
execute if score gameMode cm_main matches 4 run setblock 11 47 0 oak_wall_sign[facing=west]{front_text: {messages: ['{"bold":true,"color":"aqua","text":"Gamemode"}', '{"bold":true,"color":"dark_red","text":"Team death"}', '{"bold":true,"color":"dark_red","text":"match"}', '{"clickEvent":{"action":"run_command","value":"trigger lb_optionTrig set 100"},"color":"black","text":"[Click to cycle]"}']}} destroy
...
setblock 11 46 0 oak_wall_sign[facing=west]{front_text: {color: "yellow", messages: ['{"bold":true,"text":"Currently Selected"}', '{"bold":true,"text":"Map"}', '{"text":""}', '{"clickEvent":{"action":"run_command","value":"function lobby:signs/help/maps/check"},"color":"black","text":"[Click to cycle]"}']}} destroy
