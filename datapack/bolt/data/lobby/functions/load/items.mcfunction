...
#kill sreak items
kill @e[type=minecraft:item,name="Honey Trap"]
...
kill @e[type=minecraft:item,name="Ice Grenade"]
...
kill @e[type=minecraft:item,name="Quick Bow"]
...
kill @e[type=minecraft:item,name="Paint Trap"]
...
kill @e[type=minecraft:item,name="Extra Life"]
...
kill @e[type=minecraft:item,name="Tidal Wave"]
...
# freeze tag items
kill @e[type=minecraft:item,name="Anti-freeze"]
...
kill @e[type=minecraft:item,name="Re-freeze"]
