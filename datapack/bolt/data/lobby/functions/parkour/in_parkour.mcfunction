...
item replace entity @s hotbar.3 with ender_eye{return:1b,display:{Name:'{"text":"Return To Last Checkpoint","color":"dark_green","bold":true}',Lore:['{"text":"to return to the last checkpoint"}']},ParkourItem:1,Enchantments:[{}]}
item replace entity @s hotbar.5 with ender_eye{reset:1b,display:{Name:'{"text":"Reset Progress","color":"dark_red","bold":true}',Lore:['{"text":"to return to the start and reset your timer."}']},ParkourItem:1,Enchantments:[{}]}