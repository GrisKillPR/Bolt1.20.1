...
item replace entity @s hotbar.3 with lime_terracotta{display:{Name:'{"text":"[Drop] Return To Last Checkpoint","color":"dark_green","bold":true}',Lore:['{"text":"Drop to return to the last checkpoint"}']},ParkourItem:1,Enchantments:[{}]}
item replace entity @s hotbar.5 with red_terracotta{display:{Name:'{"text":"[Drop] Reset Progress","color":"dark_red","bold":true}',Lore:['{"text":"Drop to return to the start and reset your timer."}']},ParkourItem:1,Enchantments:[{}]}